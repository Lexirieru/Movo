const idrxAbi = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint64", name: "_burnBridgeFee", type: "uint64" },
      { internalType: "uint64", name: "_mintBridgeFee", type: "uint64" },
    ],
...
export async function checkGasFeeEstimation(
  ...
  const estimatedGas =
    await idrxContractSigner.estimateGas.burnWithAccountNumber(
      parsedAmount,
